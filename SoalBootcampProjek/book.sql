...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2020 at 11:57 AM
...
CREATE TABLE `book_tb` (
  ...
  `publiction_year` int(11) NOT NULL,
...
INSERT INTO `book_tb` (`id_book`, `name_book`, `category_id`, `writer_id`, `publiction_year`, `img`) VALUES
(1, 'The Pragmatic Programmer', 1, 1, 1999, 'book1.png'),
(2, 'Structure and Interpretation of Computer Programs', 1, 2, 1979, 'book2.png'),
(3, 'A Book of Myths', 3, 3, 1914, 'book3.png'),
(4, 'Norse Gods and Giants', 3, 4, 1967, 'book4.png'),
(5, 'The Illustrated Book of Myths: Tales & Legends of the World', 3, 5, 1995, 'book5.png');
...
--
ALTER TABLE `writer_tb`
  MODIFY `id_writ` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
